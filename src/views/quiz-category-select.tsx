        ...
        <div className="grid grid-cols-2 gap-4 px-6 lg:gap-6">
          {Array(10)
            ...
            .map((value, index) => (
              <div
                key={index}
                className="relative isolate h-16 w-40 overflow-hidden rounded-lg border bg-gray-300 before:absolute before:inset-0 before:-translate-x-full before:animate-[shimmer_2s_infinite] before:bg-gradient-to-r before:from-transparent before:via-gray-200 before:to-transparent lg:h-20 lg:w-80"
              />
            ))}
        </div>
      ) : (
